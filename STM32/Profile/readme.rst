...
Пример точности профайлера приведен ниже. Использывалась стандартная функция ``HAL_Delay(100);`` так как этот профайлер не разрабатывался и не задумывался как сверх высокоточный функционал. Он создан для оценоной характеристики и имеет погрешность ±1 мс.
